        ...
        <CardContent>
          <div className="text-center space-y-6">
                  ...
                  <div key={index} className="text-left p-4 border rounded-lg">
                    <div className="flex items-start gap-2 mb-2">
                      ...
                      <div className="flex-1">
                        ...
                        {!isCorrect && (
                          <p className="text-sm text-green-600 mt-1">Resposta correta: {question.correctAnswer}</p>
                        )}
                        {question.explanation && (
                          <p className="text-sm text-blue-600 mt-2 bg-blue-50 p-2 rounded">{question.explanation}</p>
                        )}
                      </div>
                    </div>
                  </div>
            ...
            <div className="flex gap-2 justify-center">
              ...
              <Button variant="outline">Continuar Estudando</Button>
            </div>
          </div>
        </CardContent>
      </Card>

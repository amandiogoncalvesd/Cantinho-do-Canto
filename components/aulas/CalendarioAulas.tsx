...
const CalendarioAulas = () => {
  ...
  const filteredAulas = aulasAgendadas.filter((aula) => {
    ...
    const matchesDate = !selectedDate || aula.date.toDateString() === selectedDate.toDateString()
  ...
  const getAulasForDate = (date: Date) => {
    return aulasAgendadas.filter((aula) => aula.date.toDateString() === date.toDateString())
  }
                ...
                <div key={aula.id} className="flex items-center justify-between p-4 border rounded-lg hover:bg-gray-50">
                  <div className="flex items-center gap-4">
                    <div className="text-center">
                      ...
                      <div className="text-xs text-gray-500">{format(aula.date, "dd/MM")}</div>
                    </div>
                    <div>

      ...
      {!content.url ? (
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <div className="border-2 border-dashed border-muted-foreground/25 rounded-lg p-6">
              <div className="text-center">
                ...
                <p className="text-xs text-muted-foreground mb-4">Formatos: MP4, AVI, MOV (máx. 50MB)</p>
                <input
                  type="file"
                  accept="video/*"
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-xs text-muted-foreground">Insira a URL de um vídeo hospedado online</p>
          </div>
        </div>
      ) : (
        <div className="space-y-4">
          ...
          <div className="relative bg-black rounded-lg overflow-hidden aspect-video">
            <video src={content.url} controls className="w-full h-full object-contain" preload="metadata">
              <p className="text-white text-center p-4">Seu navegador não suporta a reprodução deste vídeo.</p>
            </video>
          </div>
        </div>
      )}

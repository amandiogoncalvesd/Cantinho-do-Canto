    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <section className="py-20 bg-gradient-to-br from-primary via-primary/90 to-accent/20 text-primary-foreground relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div
            className="absolute top-32 right-20 w-16 h-16 bg-accent/30 rounded-full animate-pulse"
            style={{ animationDelay: "1s" }}
          ></div>
          <div
            className="absolute bottom-20 left-1/4 w-12 h-12 bg-accent/25 rounded-full animate-pulse"
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p
              className="text-xl md:text-2xl mb-8 text-primary-foreground/90 animate-fade-in max-w-3xl mx-auto"
              style={{ animationDelay: "0.2s" }}
            >
              Aprenda violão com professores qualificados em um ambiente acolhedor e inspirador. Transforme sua paixão
              em arte!
            </p>
            <div
      ...
      <section className="py-16 bg-gradient-to-r from-accent to-accent/80 text-accent-foreground">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">Nossos Números Falam Por Si</h2>
      ...
      <section className="py-16 bg-gradient-to-br from-primary to-primary/80 text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Comece sua jornada musical hoje!</h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
            Transforme sua paixão pela música em realidade. Junte-se à nossa comunidade musical e descubra o músico que
            existe em você.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-primary-foreground/30 text-primary-foreground hover:bg-primary-foreground/10 font-semibold px-8 py-4 bg-transparent"
            >
